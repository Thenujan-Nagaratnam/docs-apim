# Managing APIs, API Products, and MCP Servers

## Add APIs, API Products, or MCP Servers in an environment

You can add APIs, API Products, and MCP Servers via the Publisher Portal.
However, **WSO2 API Controller (apictl)** allows you to create and deploy APIs, API Products, and MCP Servers without using the Publisher Portal. For more information on adding APIs, see [Importing APIs Via Dev First Approach]({{base_path}}/install-and-setup/setup/api-controller/managing-apis-api-products/importing-apis-via-dev-first-approach). For more information on adding MCP Servers, see [Importing MCP Servers Via Dev First Approach]({{base_path}}/install-and-setup/setup/api-controller/managing-apis-api-products/importing-mcp-servers-via-dev-first-approach).

## Get APIs, API Products, or MCP Servers in an environment

Follow the instructions below to display a list of APIs, API Products, or MCP Servers in an environment using apictl:
...
3.  Run the corresponding apictl command below to get (list) APIs or API Products in an environment.
    ...
    3. Get MCP Servers in an environment.
...
## Get all revisions created for an API, API Product, or MCP Server in an environment

Follow the instructions below to display a list of revisions created for an API, API Product, or MCP Server in an environment using apictl:
 ...
 environment.
    ...
    2. Get revisions for an API Product in an environment.
        ...
        -   **Response**
            ...
            !!! tip 
                When using the `get api-revisions`, `get api-product-revisions`, and `get mcp-server-revisions` command, `-q` or `--query` optional 
            ...
            !!!note
                Output of the `get api-revisions`, `get api-product-revisions`, and `get mcp-server-revisions` commands can be formatted with Go Templates. For more information on formatting the get commands, see [Formatting the outputs of get commands]({{base_path}}/install-and-setup/setup/api-controller/advanced-topics/formatting-the-output-of-get-command).

    3. Get revisions for an MCP Server in an environment.
...
## Delete an API, API Product, or MCP Server in an environment

Follow the instructions below to delete an API, API Product, or MCP Server in an environment using apictl:
...
3.  Run the corresponding apictl command below to delete an API or an API Product in an environment.
    ...
    3. Delete an MCP Server in an environment.
...
## Change status of an API, API Product, or MCP Server in an environment

Follow the instructions below to change the status of an API, API Product, or MCP Server in an environment using apictl:
...
3.  Run the corresponding apictl command below to change the status of an API or API Product in an environment.
    ...
    3. Change status of an MCP Server in an environment.
...
## Undeploy a revision of an API, API Product, or MCP Server from all or specific deployment environments

Follow the instructions below to undeploy a revision of an API, API Product, or MCP Server from a selected gateway environment using apictl:
...
3.  Run the corresponding apictl command below to undeploy the revision from a gateway environment.
    ...
    3. Undeploy a revision of an MCP Server from gateway environments.
...
## Get the log level of APIs, MCP Servers, or an API/MCP Server in an environment

Follow the instructions below to get the logging details of APIs, MCP Servers, or an API/MCP Server in an environment using apictl:
...
3.  Run the corresponding apictl command below to get the logging details of APIs or an API in an environment.
    ...
    2. Get the logging details of MCP Servers or an MCP Server in an environment.
...
## Set the log level of an API or MCP Server in an environment

Follow the instructions below to add/change/remove the log level of an API or MCP Server in an environment using apictl:
...
3.  Run the corresponding apictl command below to set the log level of an API in an environment.
    ...
    2. Set the log level of an MCP Server in an environment.
    ...
    !!! Info
        ...
        - When you need to disable logging for an API or MCP Server, set the log level to OFF.
